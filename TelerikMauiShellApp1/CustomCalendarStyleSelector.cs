...
namespace TelerikMauiShellApp1
{
    public class CustomCalendarStyleSelector : CalendarStyleSelector
    {
        ...
        private Style customTodayLabelStyle;
        ...
        public override Style SelectStyle(object item, BindableObject container)
        {
            ...
            {
                return this.customTodayLabelStyle;
        ...
        public Style CustomTodayLabelStyle
        {
            get => customTodayLabelStyle;
            set
            {
                customTodayLabelStyle = value;
                customTodayLabelStyle.BasedOn = this.TodayBorderStyle;
            }
        }
